...
class COCOObjectDataset(CustomDataset):
    ...
    #            'clock', 'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush', 'plant')
    ...
    #            [0, 64, 0], [192, 128, 224], [64, 32, 0], [0, 192, 128], [64, 128, 224], [192, 160, 0], [162, 192, 166]]
    
    CLASSES = ( "cat", "plant")

    PALETTE = [ [192, 160, 0], [162, 192, 166]]
